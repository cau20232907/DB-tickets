    ...
    public void run(Member member) {
        ...
        switch(userInput){
            case "1":
            {
                ...
                concertDateList = ConcertDateApi.findConcertDatebyId(selectedConcert.getId());  // 전체 공연날짜 가져오기
                ...
                seatGradeList = SeatGradeApi.findSeatGradebyId(selectedStadium.getId()); // 전체 좌석등급 가져오기
                ...
                payment.setTotalBalance((int) selectedDiscountOption.getDiscountRate());
